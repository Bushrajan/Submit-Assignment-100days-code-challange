...
console.log("\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Day22:Q1 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");
console.log("Mix's text & number into one-text");
function combineStringAndNumber(text: string, number: number): string {
    return text + number;
}
console.log(combineStringAndNumber("Age: ", 18)); 
...
console.log("\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Day22:Q2 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");

// Generated by dividing two numbers
function remainder(num1: number, num2: number): number {
    return num1 % num2;
}
console.log("\nRemainder is : ", remainder(4,9)); //Remainder in terminal
//______________________________________________________________________________________________
...
console.log("\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Day22:Q3 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");

// Both inputs are true / false
function checkBothTrue(value1: boolean, value2: boolean): boolean {
    return value1 && value2;
}
console.log("\nCHECK BOTH VALUE IF : ",checkBothTrue(true, false));

function checkBothFalse(value1: boolean, value2: boolean): boolean {
    return value1 || value2;
}
console.log("\nCHECK BOTH VALUE IF : ",checkBothFalse(true, false));
//______________________________________________________________________________________________

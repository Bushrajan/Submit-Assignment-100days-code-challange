...
console.log(`\nxxxxxxxxxxxxxxxxxxxxxxxxx DAY98 xxxxxxxxxxxxxxxxxxxxxxxxx\n
  *********************** Authentication ************************
...
Authentication vs. Authorization, In web development, authentication and authorization serve different roles:
...
Day-99 Task:
Today's task is to learn about: */
console.log(`\nxxxxxxxxxxxxxxxxxxxxxxxxx DAY99 xxxxxxxxxxxxxxxxxxxxxxxxx\n
  *****Adding MetaData*****
  -----------------------------------------

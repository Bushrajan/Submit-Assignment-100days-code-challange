...
console.log("\n----------- Day60--------------- \n");
function HI(){
console.log("Function infarence...");
}
HI();
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
function text(sms:string) {
    let message = ", I'm JavaScript!"; // local variable
...
let func = () => console.log(`Arrow function start from here...`);
func();
let A = () => console.log(`Arrow function practice...\n`);
A();
...
console.log("\n----------- Day62--------------- \n");   
console.log("Setup download information complete in day 62...");   

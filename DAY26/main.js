...
function FunctionParametersandReturnValuesofaddNumbers(n1, n2) {
    return n1 + n2;
}
...
function greetingtouser(AnonymousName = "AnonymousName") {
...
const squareExpressionofthenumber = function (Num) {
    return Num * Num;
};
